...
#[derive(Debug)]
pub struct NeoSchemaProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoSchemaProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoSchema processing");
    
    let mut processor = NeoSchemaProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoSchemaProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoSchemaProcessor::new(false);
